...
public class FileDecryptor {
	private static final Logger LOG = LoggerFactory.getLogger(FileDecryptor.class);
	...
	public FileDecryptor(final Path in, final Path to, final Charset encoding, final String password) {
		this.in = in;
		this.to = to;
	...
	public void decrypt() {
		...
		try (
			InputStream is = Files.newInputStream(this.in, StandardOpenOption.CREATE, StandardOpenOption.READ);
